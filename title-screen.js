...
(function(global){
 ...
 let renderer=null,scene=null,camera=null,mixer=null,model=null,frame=0,resizeObserver=null,lastTime=performance.now();
 const debug={status:"loading",asset:"styloo-chibi-student.glb",clip:"anim_iddle",disposed:false,error:null};
